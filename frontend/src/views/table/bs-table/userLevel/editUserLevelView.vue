...
<b-form @submit.prevent>
    <b-row>
        ...
        <b-col cols="12">
            <b-form-group label="Assets Managment" label-for="assets_managments" label-cols-md="3">
                <b-form-checkbox-group id="assets_managments" v-model="formValues.assets_managments" name="assets_managments" class="demo-inline-spacing">
                    <b-form-checkbox value="C">
                        Create
                    </b-form-checkbox>
                    <b-form-checkbox value="D">
        ...
        <b-col cols="12">
            <b-form-group label="Asset Work Order" label-for="asset_work_orders" label-cols-md="3">
                <b-form-checkbox-group id="asset_work_orders" v-model="formValues.asset_work_orders" name="asset_work_orders" class="demo-inline-spacing">
                    <b-form-checkbox value="C">
                        Create
                    </b-form-checkbox>
                    <b-form-checkbox value="D">
        ...
        <b-col cols="12">
            <b-form-group label="Asset Maintenance" label-for="asset_maintenances" label-cols-md="3">
                <b-form-checkbox-group id="asset_maintenances" v-model="formValues.asset_maintenances" name="asset_maintenances" class="demo-inline-spacing">
                    <b-form-checkbox value="C">
                        Create
                    </b-form-checkbox>
                    <b-form-checkbox value="D">
            ...
            axios.get('/getRoleDetail', {
                ...
                if (response.data.hasOwnProperty('success')) {
                    if (response.data.success === true) {
                        ...
                        this.formValues.document = response.data.data.document
                        this.formValues.payment = response.data.data.payment
                        this.formValues.supplier = response.data.data.supplier
                        this.formValues.supplier_type = response.data.data.supplier_type

                        this.formValues.wallets = response.data.data.wallets
                        this.formValues.my_wallets = response.data.data.my_wallets

                        this.formValues.petty_cash = response.data.data.petty_cash
                        this.formValues.petty_cash_approve = response.data.data.petty_cash_approve
                        this.formValues.bank_account = response.data.data.bank_account
                        this.formValues.my_bank_account = response.data.data.my_bank_account
                        this.formValues.expense_accounts = response.data.data.expense_accounts
                        this.formValues.call_center = response.data.data.call_center
                        this.formValues.assets_managments = response.data.data.assets_managments
                        this.formValues.asset_maintenances = response.data.data.asset_maintenances
                        this.formValues.asset_work_orders = response.data.data.asset_work_orders
