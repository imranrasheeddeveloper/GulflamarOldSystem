        ...
        <b-form-group>
          <div class="d-flex align-items-center w-fit-content">
            <b-input-group>
              ...
              <b-input-group-append v-if="$ability.can('edit', 'rent_payment')">
                <b-button
                  size="sm"
                  :to="{ name: 'edit-accommodation-payments', params: { id: row.item.id }}"
                  v-ripple.400="'rgba(40, 199, 111, 0.15)'"
            ...
            <b-col cols="12">
              <b-card-text>
                ...
                <b-row class="border-bottom ">
                  ...
                  <b-col cols="10">
                    <a
                      v-if="isPdf(row.item.rent_reciept)"
                      class="btn btn-primary"
                    ...
                    <enlargeable-image
                      ...
                      :src_large="row.item.rent_reciept"
                      animation_duration="600"
                    >
                      <b-img
                        v-if="row.item.rent_reciept != ''"
                        style="max-height: 80px;"
                        thumbnail
                        :src="row.item.rent_reciept"
                      />
...
export default {
  ...
  data() {
    return {
      ...
      }, { key: 'date', sortable: true, thClass: 'customHead' }, { key: 'amount', sortable: true, thClass: 'customHead' }, { key: 'period', sortable: true, thClass: 'customHead' }],
      items: [
      ],
      emp_detail: [
