<template>
  ...
  <div>
    ...
    <div class="custom-search d-flex justify-content-between">
      ...
      <b-form-group v-if="$ability.can('add/copy', 'wallets')">
        <div class="d-flex align-items-center">
          <b-input-group-prepend>
                  ...
                  <b-row>
                    ...
                    <b-col cols="6">
                      <b-button
                        ...
                        size="sm"
                        variant="primary"
                        :href="'/api/walletCsv?searchTerm='+ searchTerm+' &amp;limit='+exportLimit"
                        target="_blank"
                      >
                        <feather-icon icon="DownloadIcon" />
                      </b-button>
      ...
      <template #cell(Options)="row">
        ...
        <b-form-group>
          <div class="d-flex align-items-center w-fit-content">
            <b-input-group>
              <b-input-group-prepend v-if="$ability.can('edit', 'wallets')">
                <b-button
                  size="sm"
                  v-ripple.400="'rgba(113, 102, 240, 0.15)'"
                  variant="outline-primary text-success"
                  :to="{name: 'edit-wallet', params: { id: row.item.id } }"
              ...
              <b-input-group-append>
              <b-button v-if="$ability.can('view', 'petty_cash')" 
                  size="sm"
              v-ripple.400="'rgba(40, 199, 111, 0.15)'"
              :to="{ name: 'list-patty-cash', params: { id: row.item.id }}"
              variant="outline-primary"
            >
              <feather-icon icon="SearchIcon" />
            </b-button>
...
export default {
  ...
  data() {
    return {
      ...
      }, { key: 'user_name',label: 'User Name', sortable: true, thClass: 'customHead' }, {
