        ...
        <b-row>
          ...
          <!-- <b-col cols="6">
                    <div class="d-flex pt-1 my-2">
                        <b-form-checkbox class="d-flex" value="1" v-model="formValues.approve" name="approve">
                            Approve
                        </b-form-checkbox>
                        <b-form-checkbox class="d-flex ml-2 pl-2" value="0" v-model="formValues.approve" name="approve">
                            Not Approve
                        </b-form-checkbox>
                    </div>
                </b-col> -->
  ...
  > -->
    ...
    >
      ...
      <template #cell(accept)="data">
        <!-- <b-form-checkbox :disabled="isSubmitting || data.item.accept" type="checkbox" class="m-0" :value='true' v-model="data.item.accept" @change="accept_status($event, data.item)">
  ...
  methods: {
    ...
    deleteDocument(id) {
      ...
      this.$swal({
        ...
        if (result.value) {
          axios
            .post("/deleteExpenseAccountCatgory", {
              id: id,
            })
            .then((response) => {
              if (response.data.hasOwnProperty("success")) {
