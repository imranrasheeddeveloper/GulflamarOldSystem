<template>
  <div>
    ...
    <div class="container">
      <b-row class="">
        ...
        <b-col md="2" class="border border-primary p-1 m-1 rounded">
  ...
  > -->
    ...
    >
      ...
      <template #cell(add_expense)="data">
        <!-- <b-form-checkbox :disabled="isSubmitting" type="checkbox" class="m-0"  @change="accept_status($event, data.item)">
        ...
        <b-button
          ...
          variant="success"
          class=""
          @click="accept_status($event, data.item)"
        >
          <span class="text-white">Add + </span>
        </b-button>
...
export default {
  ...
  methods: {
    ...
    getDocuments() {
      ...
      axios
        .get("/getAllTransactionExpenseAccount", {
          params: {
            id: this.$route.params.id,
            day: this.Day,
