<template>
  <div>
    ...
    <div class="custom-search d-flex justify-content-between">
      ...
      <!-- v-if="$ability.can('add/copy', 'document')" -->
      <b-form-group v-if="$ability.can('add/copy', 'petty_cash')">
        <div class="d-flex align-items-center">
          <b-input-group>
            <b-input-group-prepend>
              <div id="my-container">
    ...
    <div class="container">
      <b-row>
        ...
        <b-col
          md="3"
          class="border border-primary p-1 m-1 text-white rounded"
          style="
  ...
  >
    ...
    >
        ...
        <div>
          <div class="d-flex align-items-center w-fit-content">
            <b-input-group>
              ...
              <b-input-group-append v-if="$ability.can('edit', 'petty_cash')">
                <b-button
                  size="sm"
                  :to="{ name: 'edit-patty-cash', params: { id: row.item.id } }"
              ...
              <b-input-group-append v-if="$ability.can('delete', 'petty_cash')">
                <b-button
                  size="sm"
                  v-ripple.400="'rgba(40, 199, 111, 0.15)'"
      ...
      <template #cell(approve)="data">
        <b-form-checkbox
          :disabled="approve_status_disable(data.item)"
          type="checkbox"
          class="m-0"
          :value="true"
          v-model="data.item.approve"
          @change="approve_status($event, data.item)"
        ...
        <b-badge
          pill
          :variant="approve_statusVariant(data.value)"
          v-if="!$ability.can('edit', 'petty_cash_approve')"
        >
          <span class="text-white" v-if="data.value == true">Approve</span>
              ...
              <b-card-text>
                ...
                <b-row class="border-bottom">
                  ...
                  <b-col cols="10">
                    ...
                    <b-badge
                      pill
                      :variant="approve_statusVariant(row.item.approve)"
                    >
                      <span class="text-white" v-if="row.item.approve == true"
                        >Approve</span
                      >
                      <span class="text-white" v-if="row.item.approve == false"
                        >Not Approve</span
                      >
                    </b-badge>
                  </b-col>
                ...
                <b-row class="border-bottom">
                  ...
                  <b-col cols="10">
                    ...
                    <b-badge
                      pill
                      :variant="approve_statusVariant(row.item.accept)"
                    >
                      <span class="text-white" v-if="row.item.accept == true"
                        >Accept</span
                      >
                      <span class="text-white" v-if="row.item.accept == false"
                        >Not Accept</span
                      >
                    </b-badge>
                  </b-col>
                ...
                <b-row class="border-bottom"  v-if="row.item.assign_to_category == 'Client'">
                  <b-col cols="2">
                ...
                <b-row class="border-bottom" v-if="row.item.approved_by">
