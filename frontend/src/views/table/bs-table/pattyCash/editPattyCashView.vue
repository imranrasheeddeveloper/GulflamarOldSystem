  ...
  <b-form @submit.prevent>
    <b-row>
      ...
      <b-col md="6" v-if="walletType == false">
      ...
      <b-col md="6" v-if="walletType == true">
        <b-form-group label="Assign To Category" label-for="'Category">
          <v-select
            id="'Category"
            v-model="formValues.assign_to_category"
      ...
      <b-col md="6" v-if="walletType">
        ...
        <b-col  md="12" v-if="locationField">
                  <b-form-group
      ...
      <b-col md="4" v-if="walletType == false">
  ...
  methods: {
        ...
        .then((response) => {
          if (response.data.hasOwnProperty("success")) {
            if (response.data.success === true) {
              ...
              this.$router.replace("/List_Patty_Cash/"+this.formValues.wallet_id).then(() => {
                this.$toast({
    ...
    getDocument() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.onLocationInputChange(this.formValues.assign_to_entity_id)
          ...
          if (this.formValues.assign_to_category == 'Wallet') {
    ...
    Type_Change() {
      ...
      console.log("clear item new", this.formValues);
        ...
        Transaction_Type_Change(item) {
          ...
          if(item.transaction_type == 'Transfer to Wallet'){
            this.walletType = true;
          }else{
            this.walletType = false;
          }
    ...
    assignOwnerField(event) {
      ...
      if(this.formValues.assign_to_category == 'Client'){
         this.onLocationInputChange(event.item.id)
      }
      return;
    },
    reomveFile(file) {
