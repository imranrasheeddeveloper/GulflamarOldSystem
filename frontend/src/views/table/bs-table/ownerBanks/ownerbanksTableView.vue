<template>
  ...
  <div>
    ...
    <div class="custom-search d-flex justify-content-between">
      ...
      <b-form-group v-if="$ability.can('add/copy', 'my_bank_account')">
        <div class="d-flex align-items-center">
      ...
      <template #cell(Options)="row">
        <div>
          <div class="d-flex justify-content-start">
            <b-button
             v-if="$ability.can('edit', 'my_bank_account')"
              v-ripple.400="'rgba(40, 199, 111, 0.15)'"
              :to="{ name: 'edit-owner-banks', params: { id: row.item.id }}"
            ...
            <b-button
              v-if="$ability.can('delete', 'my_bank_account')"
              v-ripple.400="'rgba(40, 199, 111, 0.15)'"
              variant="flat-danger"
              class="btn-icon rounded-circle"
  ...
  data() {
    return {
      ...
      fields: [{ key: 'Options', thClass: 'customHead' }, {
        ...
        key: 'bank_name', label: 'BANK NAME', sortable: true, thClass: 'customHead',
      },
       {
