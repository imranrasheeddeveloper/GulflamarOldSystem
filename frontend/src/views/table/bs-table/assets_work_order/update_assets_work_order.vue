<template>
    <b-form @submit.prevent>
        <b-row>
            ...
            <b-col md="6">
                <b-form-group label="Clinet Name" label-for="client_name">
                    <vue-autosuggest :suggestions="filteredOptions" :limit="10" v-model="formValues.client_name"
                        :input-props="{id:'autosuggest__input',class:'form-control', placeholder:'Search with name or ID'}"
...
export default {
    ...
    methods: {
        ...
        submitResource() {
            ...
            console.log("new formData", this.formValues)
            axios.post('/updateWorkOrder', formData).then(response => {
                if (response.data.hasOwnProperty('success')) {
                    if (response.data.success === true) {
                        console.log(response.data.data)
                    ...
                    if (response.data.hasOwnProperty("success")) {
                        if (response.data.success === true) {
                            ...
                            this.formValues.id = response.data.data.id,
                                this.formValues.asset_id = response.data.data.asset_id[0].id,
                                this.formValues.fromDate = response.data.data.fromDate,
                                this.formValues.toDate = response.data.data.toDate,
                                this.formValues.c_id = response.data.data.c_id[0].client_code,
                                this.formValues.location_id = response.data.data.location_id[0].id,
                                this.formValues.rate_basis = response.data.data.rate_basis,
                                this.formValues.rate = response.data.data.rate,
                                this.formValues.check_out_reading = response.data.data.check_out_reading,
                                this.formValues.check_in_reading = response.data.data.check_in_reading,
                                this.formValues.scope = response.data.data.scope,
                                this.formValues.asset_name = response.data.data.asset_id[0].asset_name,
                                this.formValues.location_name = response.data.data.location_id[0].location_name,
                                this.formValues.client_name = response.data.data.c_id[0].client_name,
