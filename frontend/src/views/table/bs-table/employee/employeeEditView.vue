      ...
      axios.get('/getEmployeeDetail', {
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            ...
            this.formValues.client_location = response.data.data.client_location
            ...
            this.clinet_code = response.data.data.client.value
            this.get_client_location(response.data.data.client.value)
