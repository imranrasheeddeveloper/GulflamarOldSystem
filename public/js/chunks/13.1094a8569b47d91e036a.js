...
function useTaskHandler(props, emit) {
  ...
  var resolveAvatarVariant = function resolveAvatarVariant(tag) {
    ...
    if (tag === 'high') return 'danger'; // if (tag === 'update') return 'info'

    return 'primary';
  };

  var tagOptions = [// { label: 'Team', value: 'team' },
  {
    label: 'Low',
    value: 'low'
  }, {
...
/* harmony import */ var _axios__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @axios */ "./frontend/src/libs/axios.js");
/* harmony import */ var _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @core/components/toastification/ToastificationContent.vue */ "./frontend/src/@core/components/toastification/ToastificationContent.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var systemOwner = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_1__["ref"])([]);
    ...
    var addTask = function addTask(val) {
      console.log('Task added todo', val); // return;
    ...
    var taskTags = [// { title: 'Team', color: 'primary', route: { name: 'apps-todo-tag', params: { tag: 'team' } } },
    {
      title: 'Low',
      color: 'success',
      route: {
    ...
    var fetchTasks = function fetchTasks() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].get('/getAllTasks', {
        params: {
          filter: router.currentRoute.params.filter,
          tag: router.currentRoute.params.tag
        }
  ...
  mounted: function mounted() {// this.getAllTasks()
  },
  methods: {
    ...
    updateThisTaskCompleted: function updateThisTaskCompleted(taskData) {
      var _this = this;
      ...
      console.log('isCompleted', taskData.isCompleted); // return ;

      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].post('/isCompleteTask', {
    ...
    getAllTasks: function getAllTasks() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].get('/getAllTasks', {}).then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            /* console.log(response.data.data); */
            _this2.tasks.value = response.data.data;
            console.log('All task Fetched', _this2.tasks);
          } else {
            _this2.$toast({
              component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_12__["default"],
              position: 'top-right',
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    reset_form: function reset_form() {
      ...
      Object.entries(this.taskLocal).forEach(function (_ref3) {
    ...
    submitTask: function submitTask() {
      ...
      this.formValues = this.taskLocal;
      console.log('formvalues', this.formValues); // return ;
      ...
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].post('/addTask', this.formValues).then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data);
    ...
    deleteTask: function deleteTask(task) {
      ...
      this.isSubmitting = true;
      console.log('delete', task.id); // return;
      // this.formValues = this.taskLocal;
      ...
      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].post('/deleteTask', {
        id: task.id
      }).then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
    ...
    getAllAssignee: function getAllAssignee() {
      var _this4 = this;

      _axios__WEBPACK_IMPORTED_MODULE_11__["default"].get('/getAllAssignee', {}).then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            /* console.log(response.data.data); */
            _this4.AllAssignee = response.data.data;
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("b-form-input", {
                        ...
                        on: { input: _vm.updateRouteQuery, click: _vm.close }
                      })
                    ],
                    1
                  )
                      ...
                      _c("div", { staticClass: "todo-title-wrapper" }, [
                        _c("div", { staticClass: "todo-title-area" }, [
                          _c(
                            ...
                            [
                              _c("b-form-checkbox", {
                                attrs: { checked: task.isCompleted == 1 },
                                on: {
                                  change: function($event) {
                                    return _vm.updateThisTaskCompleted(task)
                                  }
                                },
                                nativeOn: {
                                  click: function($event) {
                              ...
                              _c(
                                "span",
                                {
                                  staticClass: "todo-description",
                                  domProps: {
                                    innerHTML: _vm._s(task.description)
                                  }
                                },
                                ...
                                _c(
                                  "b-badge",
                                  {
                                    ...
                                    attrs: {
                                      ...
                                      variant:
                                        "light-" +
                                        _vm.resolveTagVariant(task.tag)
                                    }
                                  },
                                  [
                                    _vm._v(
                            ...
                            task.assignee
                              ? _c("b-avatar", {
                                  attrs: {
                                    ...
                                    variant:
                                      "light-" +
                                      _vm.resolveAvatarVariant(task.tag),
                                    text: _vm.avatarText(task.assignee.name)
                                  }
                                })
                              : _c(
                                  "b-avatar",
                ...
                _c(
                  ...
                  [
                    _vm.taskLocal.id
                      ? _c(
                          "b-button",
                          {
                            ...
                            on: {
                              click: function($event) {
                                _vm.updateThisTaskCompleted(_vm.taskLocal)
                                hide()
                                _vm.$emit("fetch-task")
                              }
                            }
                    ...
                    _c(
                      "div",
                      [
                        _vm.taskLocal.id && _vm.isOwner(_vm.taskLocal)
                          ? _c("feather-icon", {
                              staticClass: "cursor-pointer",
                              attrs: { icon: "TrashIcon" },
                              on: {
                                click: function($event) {
                                  _vm.deleteTask(_vm.taskLocal)
                                  hide()
                                  _vm.$emit("fetch-task")
                                }
                              }
                      ...
                      "b-form",
                      {
                        ...
                        on: {
                          ...
                          reset: function($event) {
                            $event.preventDefault()
                            return _vm.reset_form.apply(null, arguments)
                          }
                        }
                      },
                      [
                        ...
                        _c(
                          ...
                          [
                            _c("v-select", {
                              ...
                              model: {
                                value: _vm.taskLocal.assignTo,
                                callback: function($$v) {
                                  _vm.$set(_vm.taskLocal, "assignTo", $$v)
                                },
                                expression: "taskLocal.assignTo"
                              }
                            })
                          ],
                          1
                        ...
                        _vm._v(" "),
                        _c("validation-provider", {
                          attrs: { name: "Due Date", rules: "required" },
                          scopedSlots: _vm._u(
                            [
                              {
                                key: "default",
                        ...
                        _c(
                          ...
                          [
                            _c("v-select", {
                              ...
                              model: {
                                value: _vm.taskLocal.tag,
                                callback: function($$v) {
                                  _vm.$set(_vm.taskLocal, "tag", $$v)
                                },
                                expression: "taskLocal.tag"
                              }
                            })
                          ],
                          1
