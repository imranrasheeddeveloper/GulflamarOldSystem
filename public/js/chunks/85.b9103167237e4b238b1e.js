...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      recipients_client: [{
        ...
        value: 'Termination / Suspension',
        text: 'Termination / Suspension'
      }, {
        value: 'Others',
        text: 'Others'
      }],
  ...
  methods: {
    Type_Change: function Type_Change(type) {
      ...
      this.formValues.recipient = null; // console.log('recipient',this.formValues.recipient);
    ...
    submitDocument: function submitDocument() {
      ...
      console.log('thi.formValues.attachment', this.formValues.attachment); // return ;
      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].post('/updateDocument', formData).then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data);

            _this.$router.replace('/document_management').then(function () {
              _this.$toast({
    ...
    getDocument: function getDocument() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/getDocument', {
        params: {
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            ...
            _this2.Type_Change(_this2.formValues.recipient_type);

            _this2.formValues.recipient = recipient;
            _this2.formValues.resource_owner_name = resource_owner_name;
            _this2.formValues.resource_owner_id = resource_owner_id;
    ...
    onInputChange: function onInputChange(text) {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/documentResourceOwner', {
        params: {
          id: text,
    ...
    clearResourceOwner: function clearResourceOwner() {
      ...
      this.filteredOptions = []; // console.log('filteredOptions',this.filteredOptions);
        ...
        [
          ...
          _c(
            ...
            [
              _c(
                "b-form-group",
                { attrs: { label: "Recipient", "label-for": "Recipient" } },
                [
                  _c("v-select", {
                    attrs: {
                      id: "Recipient",
