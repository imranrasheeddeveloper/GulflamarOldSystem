...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    assignOwnerField: function assignOwnerField(item, event) {
      console.log("item", item);
      console.log("name faraz", event.item);
      this.assign_to_entity = item.item.id;
      this.onLocationInputChange(this.assign_to_entity);
      this.client_code = this.assign_to_entity;
