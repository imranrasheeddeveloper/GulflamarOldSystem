    ...
    submitResource: function submitResource() {
      ...
      if (this.attachmentFile != null) {
        ...
        _axios__WEBPACK_IMPORTED_MODULE_4__["default"].post('/allocateResource', {
          ...
          resourceLocation: this.location_en,
                ...
                [
                  _c(
                    "b-form-group",
                    {
                      attrs: {
                        label: "Location",
                        "label-for": "resource_owner_location"
                      }
                    },
                    [
                      _c("v-select", {
                        attrs: {
                          id: "resource_owner_location",
                          dir: _vm.$store.state.appConfig.isRTL ? "rtl" : "ltr",
                        ...
                        model: {
                          value: _vm.resource_owner_location,
                          callback: function($$v) {
                            _vm.resource_owner_location = $$v
                          },
                          expression: "resource_owner_location"
                        }
                      })
                    ],
                    1
