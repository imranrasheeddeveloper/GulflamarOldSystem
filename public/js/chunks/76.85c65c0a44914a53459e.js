...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    Submit: function Submit() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/addTransaction", formData).then(function (response) {
        if (response.data.hasOwnProperty("success")) {
          if (response.data.success === true) {
            console.log(response.data.data);

            _this.$router.replace("/List_Patty_Cash/" + _this.$route.params.id).then(function () {
              _this.$toast({
