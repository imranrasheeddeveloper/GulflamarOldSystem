...
/* harmony import */ var _apps_chat_ChatLog_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../apps/chat/ChatLog.vue */ "./frontend/src/views/apps/chat/ChatLog.vue");
//
//
//
//
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            ...
            _axios__WEBPACK_IMPORTED_MODULE_4__["default"].post('/createPurchase', {
              ...
              request_seller_id: _this5.request_seller_id,
              request_seller: _this5.request_seller,
              seller_type: _this5.seller_type,
              vat_not_vat: _this5.vat_not_vat
            }).then(function (response) {
              if (response.data.hasOwnProperty('success')) {
                if (response.data.success === true) {
                  console.log(response.data.data);
