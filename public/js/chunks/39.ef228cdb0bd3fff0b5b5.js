...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: (_methods = {
    onResourceTypeChange: function onResourceTypeChange() {
      this.resourceType = this.$refs.resourceType.value;
      this.getResourceItems();
    }
  }, _defineProperty(_methods, "onResourceTypeChange", function onResourceTypeChange() {
  ...
  }), _defineProperty(_methods, "clearCanvas", function clearCanvas() {
    this.$refs.signaturePad.clearSignature();
  }), _defineProperty(_methods, "submitResource", function submitResource() {
    var _this = this;
  ...
  }), _defineProperty(_methods, "uploadImg", function uploadImg(img) {
    var _this2 = this;
      ...
      if (response.data.hasOwnProperty('success')) {
        if (response.data.success === true) {
          ...
          _axios__WEBPACK_IMPORTED_MODULE_4__["default"].post('/allocateResource', {
            ...
            resource_owner_location: _this2.resourceOwnerLocation,
  ...
  }), _defineProperty(_methods, "onLocationInputChange", function onLocationInputChange(text) {
    var _this3 = this;
    ...
    _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/getClientLocations', {
      ...
      if (response.data.hasOwnProperty('success')) {
        if (response.data.success === true) {
          ...
          _this3.fillerdLocations = response.data.data;
        } else {
          _this3.$toast({
            component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
            position: 'top-right',
  ...
  }), _defineProperty(_methods, "resourceTypeChange", function resourceTypeChange(val) {
    this.getResourceItems();
