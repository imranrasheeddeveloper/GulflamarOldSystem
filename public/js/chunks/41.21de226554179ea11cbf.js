...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get('/getEmployeeDetail', {
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            ...
            _this3.formValues.client_location = response.data.data.client_location;
            ...
            _this3.clinet_code = response.data.data.client.value;

            _this3.get_client_location(response.data.data.client.value);
    ...
    imageUpload: function imageUpload(e, eName) {
      console.log("formValues.".concat(eName));
      this.formValues[eName] = e.target.files[0];
      console.log(this.formValues.iqama);
    },
    selected_client: function selected_client(item) {
      var _this8 = this;

      console.log(item);
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get('/getClientLocations', {
        params: {
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            ...
            _this8.clientLocations = response.data.data;
          } else {
            _this8.$toast({
              component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
              position: 'top-right',
    ...
    get_client_location: function get_client_location(item) {
      var _this9 = this;
      ...
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get('/getClientLocations', {
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data.location_name);
            _this9.clientLocations = response.data.data;
          } else {
            _this9.$toast({
              component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
              position: 'top-right',
                      ...
                      _c(
                        ...
                        [
                          _c("v-select", {
                            ...
                            model: {
                              value: _vm.formValues.client_location,
                              callback: function($$v) {
                                _vm.$set(_vm.formValues, "client_location", $$v)
                              },
                              expression: "formValues.client_location"
                            }
                          })
                        ],
                        1
