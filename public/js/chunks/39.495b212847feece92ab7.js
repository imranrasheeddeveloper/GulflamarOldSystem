  ...
  methods: (_methods = {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].post('/imgUpload', formData).then(function (response) {
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            ...
            console.log(_this3.signature);
            _axios__WEBPACK_IMPORTED_MODULE_4__["default"].post('/allocateResource', {
              resourceOwnerType: _this3.resourceType,
              resourceOwnerId: _this3.resourceOwner,
              resource_owner_location: _this3.resourceOwnerLocation,
    ...
    _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/getClientLocations', {
      ...
      if (response.data.hasOwnProperty('success')) {
        if (response.data.success === true) {
          console.log(response.data.data.data, 'location_name faraz');
          _this4.fillerdLocations = response.data.data;
        } else {
          _this4.$toast({
            component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
            position: 'top-right',
    ...
    _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/getResourceItemsDropdown', {
      ...
      if (response.data.hasOwnProperty('success')) {
        if (response.data.success === true) {
          /* console.log(response.data.data); */
          if (_this6.resourceType == 'Project') {
            _this6.locationField = true;
          } else {
            _this6.locationField = false;
          }
