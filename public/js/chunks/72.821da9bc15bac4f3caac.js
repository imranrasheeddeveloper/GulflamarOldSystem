...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    totalAmount: function totalAmount(item) {
      var TotalAmount = 0; // for (let i = 0; i < this.formValues.items.length;i++){
    ...
    Submit: function Submit() {
      ...
      this.isSubmitting = true; // Remove all filteredOptions from formValues.items
      ...
      _axios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/addMyTransaction", formData).then(function (response) {
        if (response.data.hasOwnProperty("success")) {
          if (response.data.success === true) {
            console.log(response.data.data);

            _this.$router.replace("/My_List_Patty_Cash/" + _this.$route.params.id).then(function () {
              _this.$toast({
    ...
    clearResourceOwner: function clearResourceOwner(item) {
      ...
      console.log("clear item console ", this.onLocationInputChange(this.resourceOwner));
      item.assign_to_entity = "";
      item.assign_to_entity_id = "";
      item.filteredOptions = [];
      console.log("clear item new", item);
    },
    onLocationInputChange: function onLocationInputChange(text) {
      var _this2 = this;
      ...
      _axios__WEBPACK_IMPORTED_MODULE_3__["default"].get('/getClientLocations', {
        params: {
          client_code: text
        }
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data.data, 'location_name');
            _this2.fillerdLocations = response.data.data;
          } else {
            _this2.$toast({
              component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
              position: 'top-right',
    ...
    assignOwnerField: function assignOwnerField(item, event) {
      console.log("item farax", item.assign_to_entity_id);
