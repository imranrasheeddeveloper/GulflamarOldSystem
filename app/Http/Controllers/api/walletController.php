...
class walletController extends Controller
{
    ...
    public function walletCsv(Request $request){

        return Excel::download(new walletExport($request->searchTerm,(int)$request->limit), 'walletsExport.xlsx');
    ...
    public function getAllWallets(Request  $request)
    {
        ...
        return walletDataResource::collection($resourceRecords)->additional(['success' => true, 'base_url' => url('/'), 'success' => true, 'totalRows' => $totalRows, 'message' => 'Wallets fetched.']);
    }
    ...
    public function walletTransactionsExport(Request $request)
    {

        return Excel::download(new walletTransactionExport($request->searchTerm, (int)$request->limit, (int)$request->wallet_id), "WalletTransactions_" . $request->wallet_id . '_' . time() . '.xlsx');
    }
