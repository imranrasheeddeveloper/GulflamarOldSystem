...
use App\Http\Resources\rentPaymentExportResource;

use Maatwebsite\Excel\Concerns\WithHeadings;

use DB;

class rentPayemntExport implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        return rentPaymentExportResource::collection($records);
    }

    public function headings(): array
    {
        return ["ID", "Accommodation", "Date", "Amount", "Period", "Notes"];
    }
}
